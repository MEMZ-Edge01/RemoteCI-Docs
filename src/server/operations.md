...
`3.2.1.0` 是从旧 `v3.2.0` 三段稳定标签切换到 ClassIsland 四段纯数字标签后的首个版本。旧更新器不会自动发现新标签，首次迁移必须手动安装服务端或 FPK、`RemoteCI.Plugin.cipx` 和 `RemoteCI.Watch-3.2.1.0.apk`；之后稳定版可按四段数字标签自动更新。
